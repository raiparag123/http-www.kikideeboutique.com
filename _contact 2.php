				...
				<div class="col-lg-8">
					...
					<?php
						if(isset($_POST['cust_submit'])) {
							...
							$email_subject = "Mail from Kiki-Dee-Boutique";
							
							$fname2 = $_POST['cust_name'];
							$email2 = $_POST['cust_email'];
							$order2 = $_POST['order_type'];
							$message2 = $_POST['cust_message'];
							...
							$email_message .= "Full Name: ".clean_string($fname2)."\n";
							$email_message .= "EmailID: ".clean_string($email2)."\n";
							$email_message .= "Order Type: ".clean_string($order2)."\n";
							$email_message .= "Message: ".clean_string($message2)."\n";
							...
							{
								$message1 = "Sorry. The mail was not sent !! Please Try again!!";
					...
					<form class="comment-form" method="POST">
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" placeholder="Your Email" name="cust_email">
							</div>
								...
								<div class="col-md-12">
									<select class="comment-form input" name="order_type">
										...
										<option value="Make on Order Query">Make on Order Query</option>
									</select>
								</div>	
							<div class="col-md-12">
			...
			<div class="col-lg-4 col-sm-8">
				<div class="footer-widget">
					...
					<ul>
						...
						<li><a href="contact.html" class="white-text" >Book an Appointment</a></li>
